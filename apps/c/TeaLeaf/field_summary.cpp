...
void field_summary()
{
  ...
  if(complete == 1) {
    if(test_problem>0) {
      if(test_problem == 1) qa_diff=fabs((100.0*(temp/157.55084183279294))-100.0);
      if(test_problem == 2) qa_diff=fabs((100.0*(temp/106.27221178646569))-100.0);
      if(test_problem == 3) qa_diff=fabs((100.0*(temp/99.955877498324000))-100.0);
      if(test_problem == 4) qa_diff=fabs((100.0*(temp/97.277332050749976))-100.0);
      if(test_problem == 5) qa_diff=fabs((100.0*(temp/95.462351583362249))-100.0);
